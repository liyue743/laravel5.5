...
<html>
	...
	<head>
		...
		<script src="/qiantai/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
					...
					@foreach($orders as $k => $v)				
											<div class="order-status5">
												<div class="order-title">
													...
													<span>成交时间：{{date('Y-m-d H:i:s',$v->create_at)}}</span>
												</div>
														...
														<div class="move-right">
															<li class="td td-status">
																<div class="item-status">
																	<p class="Mystatus">
																	@if( $v->status == 0 )未发货
										                          @elseif( $v->status == 1 )待收货
										                          @elseif( $v->status == 2 )订单完成
										                          @elseif( $v->status == 3 )订单取消
										                          @endif
																	</p>
										                    ...
										                    @elseif( $v->status == 2 )	
										                          	...
										                          	<div class="am-btn am-btn-danger anniu"  style="margin-top: 5px">
													...
													<div class="order-left">
														<ul class="item-list">
															<li class="td td-item">
																<div class="item-pic">
																	<a href="#" class="J_MakePoint">
																		<img src="/qiantai/images/kouhong.jpg_80x80.jpg" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
																	<div class="item-basic-info">
														...
														<ul class="item-list">
															<li class="td td-item">
																<div class="item-pic">
																	<a href="#" class="J_MakePoint">
																		<img src="/qiantai/images/62988.jpg_80x80.jpg" class="itempic J_ItemImg">
																	</a>
																</div>
																<div class="item-info">
																	<div class="item-basic-info">
